...
{
    public function get_contenu1(){

        $contenu = Premieresection::all();

        return response()->json(['contenu' => $contenu], 200);
    }


    public function update_vfr1(Request $request,$id){
        ...
        $contenu = Premieresection::find($id);
        //dd( $contenu);
    ...
    public function update_ven1(Request $request,$id){
