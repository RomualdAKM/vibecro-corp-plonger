...
{
    public function get_contenu2(){

        $contenu = Deuxiemesection::all();

        return response()->json(['contenu' => $contenu], 200);
    }


    public function update_vfr2(Request $request,$id){
        ...
        $contenu = Deuxiemesection::find($id);
        //dd( $contenu);
    ...
    public function update_ven2(Request $request,$id){
